...
test('installer refuses ephemeral (npx-cache) package locations', async () => {
  ...
  assert.equal(isEphemeralInstall('/Users/x/.npm/_npx/abc123/node_modules/headroom-cc'), true);
  assert.equal(isEphemeralInstall('C:\\Users\\x\\AppData\\npm-cache\\_npx\\ab\\node_modules\\headroom-cc'), true);
  assert.equal(isEphemeralInstall('/usr/local/lib/node_modules/headroom-cc'), false);
